ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Heebie Jeebies"
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      menu.add label: 'Contact Page', priority: 1, url: '/admin/contact_pages'
      menu.add label: 'About Page', priority: 2, url: '/admin/about_pages'
    end
  end
end
